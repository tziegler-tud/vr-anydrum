...
Diese Schwingungen sollen genutzt werden, um verschiedene Anschlagspositionen voneinander unterscheiden zu können.
...
\input{parts/Auswertung.tex}
\input{parts/Discussion.tex}
\input{parts/Ausblick.tex}
